...
public class BookmyshowWebclientApplication {
	...
	@PostConstruct
	public void init() {
		webClient = WebClient.builder().baseUrl("http://localhost:2022/BookMyShow/Service")
...
/*
http://localhost:8082/bookMyShow-client/bookNow --POST
{
 	"userName":"KAJAL",
	"showName":"DDL",
...
http://localhost:8080/bookMyShow-client/trackBooking/99 --GET
*/